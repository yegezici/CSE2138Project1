...
public class sys2 {
	...
	static String floatToBin(String floatNum,int floatSize) {
        ...
        if(tempStr2.charAt(fractionSize)==1) {
        	
        }else {
        	tempStr2.substring(0, fractionSize);
        }
        ...
        if(fraction.charAt(fractionSize)=='0') {
        	...
        	String finalBin = "";
            for(int i = fractionSize;i >= 0;i--){////////////////////////////////////7
	...
	public static void main(String[] args) throws Exception {
		...
		input.close();
		inputFile.close();
		System.out.println(floatToBin("29.109375",2));
		System.out.println(floatToBin("1025.015625",4));
		System.out.println(floatToBin("-1628.953125",3));
	    }
}
